import { Controller, Get, Header, Param, Post, Query, Res, Headers, UploadedFiles, UseInterceptors } from '@nestjs/common'
  ...
  @UseInterceptors(
    FilesInterceptor('files', 3, {
      fileFilter: (req, file, callback) => {
        if (!Boolean(file.mimetype.match(/(jpg|jpeg|png|gif|mp4|video\/x-matroska)/))) callback(null, false)
        callback(null, true)
      },
      storage: diskStorage({
