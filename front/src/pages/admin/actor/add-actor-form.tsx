...
import { AvatarActor } from '@/components/avatar/avatar';
...
const AddActorForm = ({ actor, setDialogOpen }: AddActorFormProps) => {
	...
	useSuccessToast(updateSuccessMsg, updateSuccess && photoSuccess, setDialogOpen);
				...
				<div className="h-[100px] w-fit mt-3 ml-1  ">
					...
					{crop && (
						...
						>
							...
							<AvatarActor avatar_url={crop} className=" h-20 w-20  object-cover" />
						</div>
					)}
				</div>
